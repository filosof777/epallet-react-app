...
function HeaderCenterForm() {
  return (
    <form className="header-center__form" action='#'>
      <button className="header-center__btn" type='submit'><i className="fal fa-search"></i></button>
      <input className="header-center__search" type="search" placeholder='Type to search' />
      <button className="header-center__category" type='button'>All Categories <i className="fal fa-chevron-down"></i></button>
  </form>
  )
}
